...
public class ImageTargets extends Activity implements SampleAppMenuInterface
{
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(ImageTargets.this, mVuforiaFlags, "");
    ...
    {
        mTextures.add(Texture.loadTextureFromApk("WallCables.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("WallJunctions.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("WallBraces.png",
            getAssets()));
        mTextures
    ...
    private synchronized void updateApplicationStatus(int appStatus)
    {
        ...
        switch (mAppStatus)
        {
            ...
            case APPSTATUS_CAMERA_RUNNING:
                ...
                {
                    mSampleAppMenu = new SampleAppMenu(this, this, "Contractor XRay",
    ...
    private void setSampleAppMenuSettings()
    {
        ...
        group.addRadioItem("Wall Cables and Wall Junctions",
            CMD_DATASET_STONES_AND_CHIPS_DATASET, true);
        group.addRadioItem("Wall Braces", CMD_DATASET_TARMAC_DATASET, false);
